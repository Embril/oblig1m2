...
function removeFromArray(index) {
  let arrNo = index + 1;
    model.loggDisplayPage.diveLog.splice(arrNo -1 , 1);
    updateView();
  }


  function changeInArrayDisplay(i) {
    ...
    <div id="Page">
        ...
        <div id="bottomInnerGrid">
            ...
            <div id="buttonContainer">
                <button onclick="changeLog(${i}); goToDisplayPage()" id="saveClear">Save changes</button>
            </div>
...
function changeLog(index) {
  let arrNo = index;
  model.loggDisplayPage.diveLog.splice(arrNo , 1 , {
    general: {
